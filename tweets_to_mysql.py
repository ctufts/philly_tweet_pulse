...
class listener(StreamListener):
    ...
    def on_data(self, data):
      ...
      # check if the tweet is a quoted or retweeted status
          ...
          cursor.execute("INSERT INTO tweetTable (created_at, username,tweet, \
            coordinates, userTimeZone, retweeted) VALUES (%s,%s,%s,%s,%s,%s)",
            (created_at, username, tweet, final_coordinates, user_tz, retweeted))
          cnx.commit()
